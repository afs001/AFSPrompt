...
class AOKEvaluater:
    ...
    def evaluate(self, logfile=None):
        ...
        eval_str = _evaluate(self.dataset, self.result_file, direct_answer=direct_answer,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', type=str,
                        default="data/aokvqa/aokvqa_v1p0_test.json")
    parser.add_argument('--result_path', type=str,
                        default="outputs/results/20231122211306/result_20231122211306.json")
