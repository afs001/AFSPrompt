...
if __name__ == '__main__':
    ...
    parser.add_argument('--annotation_path', type=str, default='../datasets/okvqa/mscoco_val2014_annotations.json')
    parser.add_argument('--question_path', type=str, default='../datasets/okvqa/OpenEnded_mscoco_val2014_questions.json')
