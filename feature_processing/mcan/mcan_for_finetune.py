...
from feature_processing.mcan.mcan import MCAN
...
class MCANForFinetune(MCAN):
    ...
    """
    def __init__(self, __C, ANS_SIZE, base_answer_size=3129):
        super().__init__(__C, base_answer_size)

        self.proj1 = nn.Linear(__C["FLAT_OUT_SIZE"], ANS_SIZE - base_answer_size)
